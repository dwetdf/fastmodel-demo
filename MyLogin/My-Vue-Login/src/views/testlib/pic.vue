    ...
    <el-card id="search1">
      ...
      <el-row>
        <el-col :span="20">
          ...
          <el-button type="primary" round icon="el-icon-search" @click="getpicList">查询</el-button>
        </el-col>
      </el-row>
...
export default {
  ...
  methods: {
    ...
    getpicList() {
      // then表示后端查询后返回的数据
      libApi.getpicList(this.searchModel).then(response => {
        this.picList = response.data.rows // 后端返回的 json中的字段

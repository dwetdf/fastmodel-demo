    ...
    <el-card id="search1">
      ...
      <el-row>
        <el-col :span="20">
          ...
          <el-button type="primary" round icon="el-icon-search" @click="getsignalList">查询</el-button>
        </el-col>
      </el-row>

    </el-card>
    <el-card>
      <el-table :data="signalList" stripe style="width: 100%">
...
export default {
  ...
  methods: {
    ...
    getsignalList() {
      // then表示后端查询后返回的数据
      libApi.getsignalList(this.searchModel).then(response => {
        this.signalList = response.data.rows // 后端返回的 json中的字段
